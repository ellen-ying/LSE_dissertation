...
For exploratory and potentially explanatory purpose, three extra
outcomes are also measured at each time step: 1) \(\overline{B_i}\),
average beliefs regarding WWOH among all agents, 2)
\(P_s = P(B_i \ge 0.5)\), proportion of agents who are WWOH supporters,
and 3) \(\overline{\mu_{N_i}}\), average norm perception regarding WWOH
among all agents.
