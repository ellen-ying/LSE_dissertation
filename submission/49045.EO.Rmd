...
## Factors Associated With Sustaining Pluralistic Ignorance

Figure: x-axis - time step; facetting - communication rate, resistance to norm; coloring - variable type

fixed: $p_r = 0.5$, $\epsilon_{mean} = 0.5$, $\alphaa = 0.3$, $c_{mean} = 0.3$
