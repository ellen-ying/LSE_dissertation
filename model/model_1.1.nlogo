;; Model V1.1: private belief dichotomous and remain constant, norm belief normal, simple function for preference, with only neighbour behaviours being accessible
...
to set-turtle-characteristics
  ...
  ask n-of n-wwoh turtles with [ valuation-wwoh = 1 ] [ set behaviour-wwoh 1 ]
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [ valuation-wwoh = 1 ] / n-agents"
